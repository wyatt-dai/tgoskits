...
const ARCH_SPECS: &[ArchSpec] = &[
    ArchSpec {
        ...
        cross_compile: CrossCompileSpec {
            ...
            guest_tool_dir: "usr/aarch64-linux-gnu/bin",
            gnu_tool_prefix: "aarch64-linux-gnu",
    ...
    ArchSpec {
        ...
        cross_compile: CrossCompileSpec {
            ...
            guest_tool_dir: "usr/x86_64-linux-gnu/bin",
    ...
    ArchSpec {
        ...
        cross_compile: CrossCompileSpec {
            ...
            guest_tool_dir: "usr/riscv64-linux-gnu/bin",
    ...
    ArchSpec {
        ...
        cross_compile: CrossCompileSpec {
            llvm_target: "loongarch64-linux-gnu",
            cmake_system_processor: "loongarch64",
            guest_tool_dir: "usr/loongarch64-linux-gnu/bin",
            gnu_tool_prefix: "loongarch64-linux-gnu",
